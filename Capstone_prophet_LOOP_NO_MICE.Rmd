...
insert_upload_job(project, 'predictions', 'ALL_SHOWS_Predictions', percentages, billing = project, #'ALL_SHOWS_NO_MICE'
...
# write.csv(stats,"stats_ALL_SHOWS_NO_MICE.csv", row.names = FALSE)
```
